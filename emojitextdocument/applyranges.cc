...
// THIS IS SHARED FROM SIGNALBACKUP-TOOLS. DONT CHANGE IT
...
void EmojiTextDocument::applyRanges(std::string *body, std::vector<Range> *ranges, std::set<int> *positions_excluded_from_escape) const
{
...
*/
void EmojiTextDocument::prepRanges(std::vector<Range> *ranges) const
{
